...
export default function Sidebar({ active = "Dashboard" }) {
  ...
  // Dummy user (replace with real user later)
  const user = useMemo(
  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-4 left-4 z-40 rounded-lg bg-white p-2 shadow border"
      >
        <Menu size={20} />
      </button>
      ...
      <aside
        className={`fixed left-0 top-0 z-50 h-screen w-64 flex-col justify-between
        border-r border-gray-100 bg-white px-5 py-6
      ...
      >
        ...
        <div>
          ...
          <div className="mb-6 rounded-2xl border border-gray-100 bg-gradient-to-br from-green-50 to-white p-4">
            ...
            <p className="mt-1 text-xs text-gray-500">
              Keep connecting to your roots today.
            </p>
          </div>
        ...
        <button
          ...
          text-gray-600 hover:border-green-300 hover:text-green-700"
        >
          <LogOut size={18} />
          Log out
        </button>
